	...
	public class fmMessageTemplate : Form
	{
		...
		private void fmMessageTemplate_Load(object sender, EventArgs e)
		{
			try
			{
				...
				AppRegistry.GetValue(expr_0F, "local_FormMessageTemplateWidth", ref num, ref this.strError);
				AppRegistry.GetValue(expr_0F, "local_FormMessageTemplateHeight", ref num2, ref this.strError);
				if (num2 != 0)
				{
					base.Height = num2;
				}
			...
			{
				this.appManager.ShowBalloon("Exception creating Message Templates form: " + ex.Message, 5);
			}
		}
		...
		private void fmMessageTemplate_FormClosing(object sender, FormClosingEventArgs e)
		{
			try
			{
				...
				AppRegistry.SaveValue(expr_0B, "local_FormMessageTemplateWidth", base.Width, ref this.strError, false, RegistryValueKind.Unknown);
				AppRegistry.SaveValue(expr_0B, "local_FormMessageTemplateHeight", base.Height, ref this.strError, false, RegistryValueKind.Unknown);
			}
			catch
			{
			}
		...
		private void buttonSave_Click(object sender, EventArgs e)
		{
			...
			try
			{
				AppRegistry.SaveValue(rootKey, "MessageTemplate1", this.textBoxMessageTemplate1.Text, ref empty, false, RegistryValueKind.Unknown);
				if (empty != string.Empty)
				{
					this.strError = this.strError + "Message template 1 save error: " + empty;
					flag = false;
				}
				else
				{
			...
			{
				this.strError = this.strError + "Message template 1 save error: " + ex.Message;
				flag = false;
			}
			try
			{
				AppRegistry.SaveValue(rootKey, "MessageTemplate2", this.textBoxMessageTemplate2.Text, ref empty, false, RegistryValueKind.Unknown);
				if (empty != string.Empty)
				{
					this.strError = this.strError + "Message template 2 save error: " + empty;
					flag = false;
				}
				else
				{
			...
			{
				this.strError = this.strError + "Message template 2 save error: " + ex2.Message;
				flag = false;
			}
			try
			{
				AppRegistry.SaveValue(rootKey, "MessageTemplate3", this.textBoxMessageTemplate3.Text, ref empty, false, RegistryValueKind.Unknown);
				if (empty != string.Empty)
				{
					this.strError = this.strError + "Message template 3 save error: " + empty;
					flag = false;
				}
				else
				{
			...
			{
				this.strError = this.strError + "Message template 3 save error: " + ex3.Message;
				flag = false;
			}
			try
			{
				AppRegistry.SaveValue(rootKey, "MessageTemplate4", this.textBoxMessageTemplate4.Text, ref empty, false, RegistryValueKind.Unknown);
				if (empty != string.Empty)
				{
					this.strError = this.strError + "Message template 4 save error: " + empty;
					flag = false;
				}
				else
				{
			...
			{
				this.strError = this.strError + "Message template 4 save error: " + ex4.Message;
				flag = false;
			}
			try
			{
				AppRegistry.SaveValue(rootKey, "MessageTemplate5", this.textBoxMessageTemplate5.Text, ref empty, false, RegistryValueKind.Unknown);
				if (empty != string.Empty)
				{
					this.strError = this.strError + "Message template 5 save error: " + empty;
					flag = false;
				}
				else
				{
			...
			{
				this.strError = this.strError + "Message template 5 save error: " + ex5.Message;
				flag = false;
			}
			try
			{
				AppRegistry.SaveValue(rootKey, "MessageTemplate6", this.textBoxMessageTemplate6.Text, ref empty, false, RegistryValueKind.Unknown);
				if (empty != string.Empty)
				{
					this.strError = this.strError + "Message template 6 save error: " + empty;
					flag = false;
				}
				else
				{
			...
			{
				this.strError = this.strError + "Message template 6 save error: " + ex6.Message;
				flag = false;
			}
			try
			{
				AppRegistry.SaveValue(rootKey, "MessageTemplate7", this.textBoxMessageTemplate7.Text, ref empty, false, RegistryValueKind.Unknown);
				if (empty != string.Empty)
				{
					this.strError = this.strError + "Message template 7 save error: " + empty;
					flag = false;
				}
				else
				{
			...
			{
				this.strError = this.strError + "Message template 7 save error: " + ex7.Message;
				flag = false;
			}
			try
			{
				AppRegistry.SaveValue(rootKey, "MessageTemplate8", this.textBoxMessageTemplate8.Text, ref empty, false, RegistryValueKind.Unknown);
				if (empty != string.Empty)
				{
					this.strError = this.strError + "Message template 8 save error: " + empty;
					flag = false;
				}
				else
				{
			...
			{
				this.strError = this.strError + "Message template 8 save error: " + ex8.Message;
				flag = false;
			}
			try
			{
				AppRegistry.SaveValue(rootKey, "MessageTemplate9", this.textBoxMessageTemplate9.Text, ref empty, false, RegistryValueKind.Unknown);
				if (empty != string.Empty)
				{
					this.strError = this.strError + "Message template 9 save error: " + empty;
					flag = false;
				}
				else
				{
			...
			{
				this.strError = this.strError + "Message template 9 save error: " + ex9.Message;
				flag = false;
			}
			try
			{
				AppRegistry.SaveValue(rootKey, "MessageTemplate10", this.textBoxMessageTemplate10.Text, ref empty, false, RegistryValueKind.Unknown);
				if (empty != string.Empty)
				{
					this.strError = this.strError + "Message template 10 save error: " + empty;
					flag = false;
				}
				else
				{
			...
			{
				this.strError = this.strError + "Message template 10 save error: " + ex10.Message;
				flag = false;
			}
			if (flag)
			{
		...
		private void InitializeComponent()
		{
			...
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(fmMessageTemplate));
			...
			this.buttonSave.Location = new Point(247, 841);
			this.buttonSave.Name = "buttonSave";
			this.buttonSave.Size = new Size(80, 25);
			this.buttonSave.TabIndex = 0;
			this.buttonSave.Text = "Save All";
			this.buttonSave.UseVisualStyleBackColor = true;
			this.buttonSave.Click += new EventHandler(this.buttonSave_Click);
			this.textBoxMessageTemplate1.Anchor = (AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right);
			this.textBoxMessageTemplate1.Location = new Point(12, 48);
			this.textBoxMessageTemplate1.MaximumSize = new Size(800, 60);
			this.textBoxMessageTemplate1.MaxLength = 250;
			this.textBoxMessageTemplate1.MinimumSize = new Size(315, 60);
			...
			this.textBoxMessageTemplate1.Size = new Size(315, 60);
			this.textBoxMessageTemplate1.TabIndex = 11;
			this.labelMessageTemplate1.Anchor = (AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right);
			...
			this.labelMessageTemplate1.Location = new Point(12, 29);
			this.labelMessageTemplate1.Name = "labelMessageTemplate1";
			this.labelMessageTemplate1.Size = new Size(128, 16);
			this.labelMessageTemplate1.TabIndex = 17;
			this.labelMessageTemplate1.Text = "Message Template 1";
			this.labelMessageTemplate2.Anchor = (AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right);
			...
			this.labelMessageTemplate2.Size = new Size(128, 16);
			this.labelMessageTemplate2.TabIndex = 20;
			this.labelMessageTemplate2.Text = "Message Template 2";
			this.textBoxMessageTemplate2.Anchor = (AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right);
			this.textBoxMessageTemplate2.Location = new Point(12, 129);
			this.textBoxMessageTemplate2.MaximumSize = new Size(800, 60);
			this.textBoxMessageTemplate2.MaxLength = 250;
			this.textBoxMessageTemplate2.MinimumSize = new Size(315, 60);
			...
			this.textBoxMessageTemplate2.Size = new Size(315, 60);
			this.textBoxMessageTemplate2.TabIndex = 18;
			this.labelMessageTemplate4.Anchor = (AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right);
			...
			this.labelMessageTemplate4.Location = new Point(12, 271);
			this.labelMessageTemplate4.Name = "labelMessageTemplate4";
			this.labelMessageTemplate4.Size = new Size(128, 16);
			this.labelMessageTemplate4.TabIndex = 26;
			this.labelMessageTemplate4.Text = "Message Template 4";
			this.textBoxMessageTemplate4.Anchor = (AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right);
			...
			this.textBoxMessageTemplate4.MinimumSize = new Size(315, 60);
			...
			this.textBoxMessageTemplate4.Size = new Size(315, 60);
			this.textBoxMessageTemplate4.TabIndex = 24;
			this.labelMessageTemplate3.Anchor = (AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right);
			...
			this.labelMessageTemplate3.Location = new Point(12, 191);
			this.labelMessageTemplate3.Name = "labelMessageTemplate3";
			this.labelMessageTemplate3.Size = new Size(128, 16);
			this.labelMessageTemplate3.TabIndex = 23;
			this.labelMessageTemplate3.Text = "Message Template 3";
			this.textBoxMessageTemplate3.Anchor = (AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right);
			...
			this.textBoxMessageTemplate3.MinimumSize = new Size(315, 60);
			...
			this.textBoxMessageTemplate3.Size = new Size(315, 60);
			this.textBoxMessageTemplate3.TabIndex = 21;
			this.labelMessageTemplate6.Anchor = (AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right);
			...
			this.labelMessageTemplate6.Location = new Point(13, 433);
			this.labelMessageTemplate6.Name = "labelMessageTemplate6";
			this.labelMessageTemplate6.Size = new Size(128, 16);
			this.labelMessageTemplate6.TabIndex = 32;
			this.labelMessageTemplate6.Text = "Message Template 6";
			this.textBoxMessageTemplate6.Anchor = (AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right);
			this.textBoxMessageTemplate6.Location = new Point(13, 452);
			this.textBoxMessageTemplate6.MaximumSize = new Size(800, 60);
			this.textBoxMessageTemplate6.MaxLength = 250;
			this.textBoxMessageTemplate6.MinimumSize = new Size(315, 60);
			...
			this.textBoxMessageTemplate6.Size = new Size(315, 60);
			this.textBoxMessageTemplate6.TabIndex = 30;
			this.labelMessageTemplate5.Anchor = (AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right);
			...
			this.labelMessageTemplate5.Location = new Point(12, 352);
			this.labelMessageTemplate5.Name = "labelMessageTemplate5";
			this.labelMessageTemplate5.Size = new Size(128, 16);
			this.labelMessageTemplate5.TabIndex = 29;
			this.labelMessageTemplate5.Text = "Message Template 5";
			this.textBoxMessageTemplate5.Anchor = (AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right);
			this.textBoxMessageTemplate5.Location = new Point(12, 371);
			this.textBoxMessageTemplate5.MaximumSize = new Size(800, 60);
			this.textBoxMessageTemplate5.MaxLength = 250;
			this.textBoxMessageTemplate5.MinimumSize = new Size(315, 60);
			...
			this.textBoxMessageTemplate5.Size = new Size(315, 60);
			this.textBoxMessageTemplate5.TabIndex = 27;
			this.labelMessageTemplate8.Anchor = (AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right);
			...
			this.labelMessageTemplate8.Location = new Point(13, 594);
			this.labelMessageTemplate8.Name = "labelMessageTemplate8";
			this.labelMessageTemplate8.Size = new Size(128, 16);
			this.labelMessageTemplate8.TabIndex = 38;
			this.labelMessageTemplate8.Text = "Message Template 8";
			this.textBoxMessageTemplate8.Anchor = (AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right);
			this.textBoxMessageTemplate8.Location = new Point(13, 613);
			this.textBoxMessageTemplate8.MaximumSize = new Size(800, 60);
			this.textBoxMessageTemplate8.MaxLength = 250;
			this.textBoxMessageTemplate8.MinimumSize = new Size(315, 60);
			...
			this.textBoxMessageTemplate8.Size = new Size(315, 60);
			this.textBoxMessageTemplate8.TabIndex = 36;
			this.labelMessageTemplate7.Anchor = (AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right);
			...
			this.labelMessageTemplate7.Location = new Point(12, 513);
			this.labelMessageTemplate7.Name = "labelMessageTemplate7";
			this.labelMessageTemplate7.Size = new Size(128, 16);
			this.labelMessageTemplate7.TabIndex = 35;
			this.labelMessageTemplate7.Text = "Message Template 7";
			this.textBoxMessageTemplate7.Anchor = (AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right);
			this.textBoxMessageTemplate7.Location = new Point(12, 532);
			this.textBoxMessageTemplate7.MaximumSize = new Size(800, 60);
			this.textBoxMessageTemplate7.MaxLength = 250;
			this.textBoxMessageTemplate7.MinimumSize = new Size(315, 60);
			...
			this.textBoxMessageTemplate7.Size = new Size(315, 60);
			this.textBoxMessageTemplate7.TabIndex = 33;
			this.labelMessageTemplate10.Anchor = (AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right);
			...
			this.labelMessageTemplate10.Location = new Point(12, 756);
			this.labelMessageTemplate10.Name = "labelMessageTemplate10";
			this.labelMessageTemplate10.Size = new Size(135, 16);
			this.labelMessageTemplate10.TabIndex = 44;
			this.labelMessageTemplate10.Text = "Message Template 10";
			this.textBoxMessageTemplate10.Anchor = (AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right);
			this.textBoxMessageTemplate10.Location = new Point(12, 775);
			this.textBoxMessageTemplate10.MaximumSize = new Size(800, 60);
			this.textBoxMessageTemplate10.MaxLength = 250;
			this.textBoxMessageTemplate10.MinimumSize = new Size(315, 60);
			...
			this.textBoxMessageTemplate10.Size = new Size(315, 60);
			this.textBoxMessageTemplate10.TabIndex = 42;
			this.labelMessageTemplate9.Anchor = (AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right);
			...
			this.labelMessageTemplate9.Location = new Point(13, 675);
			this.labelMessageTemplate9.Name = "labelMessageTemplate9";
			this.labelMessageTemplate9.Size = new Size(128, 16);
			this.labelMessageTemplate9.TabIndex = 41;
			this.labelMessageTemplate9.Text = "Message Template 9";
			this.textBoxMessageTemplate9.Anchor = (AnchorStyles.Top | AnchorStyles.Left | AnchorStyles.Right);
			this.textBoxMessageTemplate9.Location = new Point(13, 694);
			this.textBoxMessageTemplate9.MaximumSize = new Size(800, 60);
			this.textBoxMessageTemplate9.MaxLength = 250;
			this.textBoxMessageTemplate9.MinimumSize = new Size(315, 60);
			...
			this.textBoxMessageTemplate9.Size = new Size(315, 60);
			this.textBoxMessageTemplate9.TabIndex = 39;
			this.buttonSave2.Font = new Font("Arial", 11.25f, FontStyle.Regular, GraphicsUnit.Point, 0);
			this.buttonSave2.Location = new Point(247, 8);
			this.buttonSave2.Name = "buttonSave2";
			this.buttonSave2.Size = new Size(80, 25);
			this.buttonSave2.TabIndex = 45;
			...
			this.panelMessageTemplate.Size = new Size(354, 423);
			this.panelMessageTemplate.TabIndex = 46;
			...
			this.rapidSpellAsYouTypeTemplate1.UnderlineColor = Color.Red;
			...
			this.rapidSpellAsYouTypeTemplate2.UnderlineColor = Color.Red;
			...
			this.rapidSpellAsYouTypeTemplate3.UnderlineColor = Color.Red;
			...
			this.rapidSpellAsYouTypeTemplate4.UnderlineColor = Color.Red;
			...
			this.rapidSpellAsYouTypeTemplate5.UnderlineColor = Color.Red;
			...
			this.rapidSpellAsYouTypeTemplate6.UnderlineColor = Color.Red;
			...
			this.rapidSpellAsYouTypeTemplate7.UnderlineColor = Color.Red;
			...
			this.rapidSpellAsYouTypeTemplate8.UnderlineColor = Color.Red;
			...
			this.rapidSpellAsYouTypeTemplate9.UnderlineColor = Color.Red;
			...
			this.rapidSpellAsYouTypeTemplate10.UnderlineColor = Color.Red;
			...
			base.ClientSize = new Size(354, 423);
			base.Controls.Add(this.panelMessageTemplate);
			base.Icon = (Icon)componentResourceManager.GetObject("$this.Icon");
			base.MaximizeBox = false;
			this.MaximumSize = new Size(370, 912);
