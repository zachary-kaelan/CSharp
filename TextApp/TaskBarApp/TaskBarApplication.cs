namespace TaskBarApp
{
    ...
    public class TaskBarApplication : ApplicationContext
    {
            ...
            if (this.appManager.m_bConnected)
            {
                if (this.appManager.m_bEnableKeywordProcessing)
                {
                    ToolStripMenuItem item = new ToolStripMenuItem {
                        Text = "Keyword Processing Enabled",
                        BackColor = ColorTranslator.FromHtml("#93FF14")
                    };
                ...
                if (this.appManager.m_bEnableGroupScheduleProcessing)
                {
                    ToolStripMenuItem item2 = new ToolStripMenuItem {
                        Text = "Group Schedule Processing Enabled",
                        BackColor = ColorTranslator.FromHtml("#93FF14")
                    };
                    this.notifyIcon.ContextMenuStrip.Items.Add(item2);
        ...
        private void Initialize()
        {
            ...
            NotifyIcon icon1 = new NotifyIcon(this.components) {
                ContextMenuStrip = new ContextMenuStrip(),
                Icon = Resources.blank,
                Text = "",
                Visible = true
            };
            this.notifyIcon = icon1;
