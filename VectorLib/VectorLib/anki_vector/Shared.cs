      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 8: {
            Result = (global::Anki.Vector.ExternalInterface.ProtocolVersionResponse.Types.Result) input.ReadEnum();
            break;
          }
          case 16: {
  ...
  public sealed partial class EventResponse : pb::IMessage<EventResponse> {
    ...
    public void MergeFrom(EventResponse other) {
      ...
      if (other.event_ != null) {
        if (event_ == null) {
          Event = new global::Anki.Vector.ExternalInterface.Event();
        }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 16: {
            Code = (global::Anki.Vector.ExternalInterface.UserAuthenticationResponse.Types.Code) input.ReadEnum();
            break;
          }
          case 26: {
